...
void NewVector::AngleMatrix ( QAngle& Rotation, float ( *matrix )[3] )
{
...
void NewVector::VectorRotate ( NewVector& In, QAngle& Rotation )
{
	float matRotate[3][3];
...
QAngle NewVector::ToEulerAngles()
{
...
QAngle NewVector::ToEulerAngles ( NewVector* PseudoUp )
{
	NewVector Left;
